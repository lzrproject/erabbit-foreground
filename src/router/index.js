...
const Seckill = () => import('@/views/goods/seckIndex')

const Login = () => import('@/views/login/index')
const LoginCallback = () => import('@/views/login/callback')

const Checkout = () => import('@/views/member/pay/checkout')
const SeckillCheckout = () => import('@/views/member/pay/seckillCheckout')
...
const routes = [
  // 一级路由布局容器
  {
    ...
    children: [
      ...
      { path: '/productSeckill/:time/:seckillId', component: Seckill }, // 秒杀路由
      { path: '/cart', component: Cart },
      { path: '/member/checkout', component: Checkout },
      { path: '/member/seckillCheckout/:time/:seckillId', component: SeckillCheckout }, // 秒杀下单
