 ...
 */
export const findGoods = (spuId) => {
  return request('http://localhost:18071/goods/getOne', 'get', { spuId })
}
 ...
 * @param {String} id - 商品ID
 */
export const findseckillGoods = (time, seckillId) => {
  return request('http://localhost:10015/seckillGoods/getOne', 'get', { time, seckillId })
}
