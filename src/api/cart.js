...
// }
export const mergeCart = (cartList) => {
  return request('http://localhost:10015/member/cart/merge', 'post', cartList)
}
...
export const findCart = () => {
  return request('http://localhost:10015/member/cart', 'get')
}
...
export const insertCart = ({ skuId, count }) => {
  return request('http://localhost:10015/member/addCart', 'post', { skuId, count })
}
...
export const deleteCart = (skuIds) => {
  return request('http://localhost:10015/member/delCart', 'post', { skuIds })
}
