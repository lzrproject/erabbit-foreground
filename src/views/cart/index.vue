        ...
        <table>
          ...
          <tbody>
            ...
            <tr v-for="goods in $store.getters['cart/validList']" :key="goods.skuId">
              ...
              <td class="tc">
                <p>&yen;{{goods.price}}</p>
                <p v-if="goods.price-goods.price>0">
                  比加入时降价 <span class="red">&yen;{{goods.price-goods.price}}</span>
                </p>
              </td>
              <td class="tc">
              ...
              <td class="tc">
                <p class="f16 red">&yen;{{Math.round(goods.price*100)*goods.count/100}}</p>
              </td>
              <td class="tc">
          ...
          <tbody v-if="$store.getters['cart/invalidList'].length">
            ...
            <tr v-for="goods in $store.getters['cart/invalidList']" :key="goods.skuId">
              ...
              <td class="tc"><p>&yen;{{goods.price}}</p></td>
              <td class="tc">{{goods.count}}</td>
              <td class="tc"><p>&yen;{{Math.round(goods.price*100)*goods.count/100}}}</p></td>
              <td class="tc">
                <p><a @click="deleteCart(goods.skuId)" class="green" href="javascript:;">删除</a></p>
                <p><a href="javascript:;">找相似</a></p>
              </td>
...
export default {
  ...
  setup () {
    ...
    return { checkOne, checkAll, deleteCart, updateCount, updateCartSku, checkout }
  }
}
</script>
